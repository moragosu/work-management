  ...
  <div class="layout" @mousemove="onMouseMove" @mouseover="onMouseOver" @mouseout="onMouseOut" @click="tooltip.visible = false" @mouseleave="tooltip.visible = false">
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <RouterLink to="/answer-history" class="nav-item" active-class="active">
          <span class="nav-icon material-symbols-outlined">chat_bubble_outline</span>
          <span class="nav-text">답변 현황</span>
        </RouterLink>
